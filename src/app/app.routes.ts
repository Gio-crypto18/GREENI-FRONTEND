...
import { Reporteresumen } from './components/reporteresumen/reporteresumen';
import { TopInteraccion } from './components/top-interaccion/top-interaccion';
...
{ path: 'recordatorio', component: Recordatorio,
  ...
  { path: 'interaccion', component: Interaccion,
        children: [
          ...
          { path: 'resumen', component: Reporteresumen },
          { path: 'top', component: TopInteraccion },
...
{ path: 'estadorecordatorio', component: EstadoRecordatorio,
  ...
  children: [
    ...
    { path: 'editar/:id', component: Guiainsertar }
      ...
      /* API diagnóstico demo dentro del layout si quieres */
