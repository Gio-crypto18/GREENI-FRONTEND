...
import { Reportecantidadrecordatorioporestado } from './components/reportecantidadrecordatorioporestado/reportecantidadrecordatorioporestado';
import { Reportecantidadtiporecordatorio } from './components/reportecantidadtiporecordatorio/reportecantidadtiporecordatorio';
...
export const routes: Routes = [
  ...
  /* === ZONA PRINCIPAL CON LAYOUT (TODO LO IMPORTANTE VA AQUÍ) === */
  {
    ...
    children: [
      ...
      { path: 'cantidadporestado', component:Reportecantidadrecordatorioporestado },
      { path: 'cantidadtipo', component:Reportecantidadtiporecordatorio },
