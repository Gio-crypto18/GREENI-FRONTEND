...
@Component({
  ...
  imports: [ReactiveFormsModule,MatInputModule,MatFormField,MatSelectModule,MatRadioModule,MatDatepickerModule,MatButtonModule,RouterLink],
...
this.form = this.formBuilder.group({
  ...
  aceptar(): void {
    if (this.form.valid) {
      ...
      this.router.navigate(['/app/estadorecordatorio']);
    }
  }
  init() {
    if (this.edicion) {
