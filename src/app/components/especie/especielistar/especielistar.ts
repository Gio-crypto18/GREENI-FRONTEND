...
@Component({
  ...
  imports: [MatTableModule, MatIconModule, RouterLink, MatButtonModule, MatPaginator,MatSnackBarModule],
...
export class Especielistar implements OnInit {
  ...
  constructor(private eS: Especieservice, private snackBar: MatSnackBar,private loginService: Loginservice) {}
