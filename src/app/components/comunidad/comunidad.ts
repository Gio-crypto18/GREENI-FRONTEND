...
export class ComunidadComponent implements OnInit {
  ...
  posts: Post[] = [
    ...
    },
    {
      ...
      date: 'Hace 2 días',
      content:
        '¡Hoy hace mucho sol! Perfecto para regar nuestras plantas con energía positiva.',
      liked: false,
      saved: false,
    },
    {
  ...
  // posts que se muestran (afectados por el buscador)
  filteredPosts: Post[] = [];
  ...
  ngOnInit(): void {
    // Al inicio se muestran todos los posts
  ...
  private applyFilters(): void {
    ...
    this.filteredPosts = this.posts.filter((post) => {
      ...
      return (
        texto.includes(this.searchTerm) || autor.includes(this.searchTerm)
      );
    });
  }
  ...
  searchTrend(tag: string): void {
    // usamos el texto del hashtag como término de búsqueda
