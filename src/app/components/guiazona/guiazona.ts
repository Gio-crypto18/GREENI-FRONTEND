...
export class Guiazona implements OnInit {
  ...
  esPaginaPersonalizadas: boolean = false; // Agregar esta variable
    ...
    return [
      {
        ...
        tipoGuia: 'interior',
        contenidoGuia: 'Aprende los fundamentos para mantener tus plantas de interior saludables. Incluye información sobre riego, luz, humedad y fertilización adecuada para diferentes tipos de plantas de interior.'
      },
      {
        guiaId: 2,
        tituloGuia: 'Guía Completa de Riego',
        tipoGuia: 'riego',
        contenidoGuia: 'Descubre cómo regar correctamente tus plantas según su tipo, estación del año y condiciones ambientales. Aprende a identificar signos de exceso o falta de agua.'
      },
      {
        guiaId: 3,
        tituloGuia: 'Plantas de Exterior Resistentes',
        tipoGuia: 'exterior',
        contenidoGuia: 'Conoce las mejores plantas para jardines exteriores que requieren poco mantenimiento y son resistentes a diferentes condiciones climáticas.'
      },
      {
        guiaId: 4,
        tituloGuia: 'Técnicas de Poda para Plantas Ornamentales',
        tipoGuia: 'poda',
        contenidoGuia: 'Aprende cuándo y cómo podar tus plantas ornamentales para promover un crecimiento saludable y mantener su forma estética. Incluye técnicas para diferentes especies.'
      },
      {
        guiaId: 5,
        tituloGuia: 'Cuidados Esenciales para Suculentas',
        tipoGuia: 'cuidados',
        contenidoGuia: 'Guía específica para el cuidado de suculentas, incluyendo requisitos de luz, riego adecuado, suelo ideal y cómo propagar estas plantas resistentes.'
      }
    ];
  }
